"""Vector retriever: embed query, cosine search over stored embeddings."""
import time
...
class VectorRetriever(BaseRetriever):
    ...
    def _load(self) -> None:
        if self._embeddings is not None:
            return
        base = self._index_dir or index_path("technical", "vectors.npz").parent
        npz_path = base / "technical_vectors.npz"
        meta_path = base / "technical_docs.json"
